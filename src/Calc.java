...
static void moD(){
    ...
    int numB = 0;//assign biggest data
    ...
    System.out.println("MOD number is " + numB);
...
static void rectangle2(){
    Scanner dat = new Scanner(System.in);
    System.out.println("Enter rectangle dimesion (a)= ");//ask for dimension a
    int a = dat.nextInt();
    System.out.println("Enter rectangle dimesion (b)= ");//ask for dimension b
    int b = dat.nextInt();
    System.out.println("Rectangle area is " + (a*b));
    System.out.println("Rectangle perimeter is " + (a+b)*2);
